...
(function (global, doc) {
  ...
  createActions.forEach(function (container) {
    ...
    var cancelBtn = container.querySelector('.ibexa-extra-actions__btn--cancel');
    var closeBtn = container.querySelector('.ibexa-extra-actions__header .ibexa-btn--close');
...
(function (global, doc, ibexa, React, ReactDOM, Translator) {
  ...
  var openUDW = function openUDW(event) {
    ...
    var title = Translator.trans( /*@Desc("Select Location")*/'copy.title', {}, 'universal_discovery_widget');
...
(function (global, doc, ibexa, React, ReactDOM, Translator) {
  ...
  var openUDW = function openUDW(event) {
    event.preventDefault();
    var title = Translator.trans( /*@Desc("Select Location")*/'subtree.title', {}, 'universal_discovery_widget');
    var config = JSON.parse(event.currentTarget.dataset.udwConfig);
    udwRoot = ReactDOM.createRoot(udwContainer);
    udwRoot.render(React.createElement(ibexa.modules.UniversalDiscovery, _objectSpread({
      onConfirm: onConfirm,
...
(function (global, doc, ibexa, React, ReactDOM, Translator) {
  ...
  var openUDW = function openUDW(event) {
    ...
    var config = JSON.parse(event.currentTarget.dataset.udwConfig);
    var title = Translator.trans( /*@Desc("Select Location")*/'add_location.title', {}, 'universal_discovery_widget');
    udwRoot = ReactDOM.createRoot(udwContainer);
    udwRoot.render(React.createElement(ibexa.modules.UniversalDiscovery, _objectSpread({
      onConfirm: onConfirm,
      onCancel: onCancel,
...
(function (global, doc, ibexa, React, ReactDOM, Translator) {
  ...
  var openUDW = function openUDW(event) {
    event.preventDefault();
    var config = JSON.parse(event.currentTarget.dataset.udwConfig);
    var title = Translator.trans( /*@Desc("Select destination")*/'move.title', {}, 'universal_discovery_widget');
    udwRoot = ReactDOM.createRoot(udwContainer);
    udwRoot.render(React.createElement(ibexa.modules.UniversalDiscovery, _objectSpread({
      onConfirm: onConfirm,
      onCancel: onCancel,
...
(function (global, doc, ibexa, React, ReactDOM, Translator) {
  ...
  var openUDW = function openUDW(event) {
    event.preventDefault();
    var config = JSON.parse(event.currentTarget.dataset.udwConfig);
    var title = Translator.trans( /*@Desc("Select Location to swap with")*/'swap.title', {}, 'universal_discovery_widget');
    udwRoot = ReactDOM.createRoot(udwContainer);
    udwRoot.render(React.createElement(ibexa.modules.UniversalDiscovery, _objectSpread({
      onConfirm: onConfirm,
      onCancel: onCancel,
...
(function (global, doc, ibexa) {
  ...
  var contentTypeGroups = _toConsumableArray(contentFormContainer.querySelectorAll('.ibexa-instant-filter__group'));
  ...
  var preparePermissionsWidget = function preparePermissionsWidget(permissions) {
    ...
    var visibleTypes = permissions.restrictedContentTypeIds.map(function (contentTypeId) {
...
(function (global, doc, bootstrap, ibexa) {
  var scheduleHideWidget = doc.querySelector('.ibexa-extra-actions--schedule-hide');
  if (!scheduleHideWidget) {
    return;
  }
  var confirmButton = doc.querySelector('.ibexa-btn--hide-confirm');
  var modal = doc.querySelector('#hide-content-modal');
  var hideLaterRadio = scheduleHideWidget.querySelector('#hide-later');
  var hideNowRadio = scheduleHideWidget.querySelector('#hide-now');
  var pickerField = scheduleHideWidget.querySelector('.ibexa-picker');
